...
function App() {
  const [authLoading, setAuthLoading] = import_react.useState(true);
  const [user, setUser] = import_react.useState(null);
  const [loading, setLoading] = import_react.useState(false);
  const [games, setGames] = import_react.useState([]);
  ...
  const fetchAndReveal = import_react.useCallback(async () => {
    setError(null);
    setLoading(true);
    try {
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: `cta-wrap ${revealed ? "revealed" : ""}`,
        children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
          type: "button",
          className: `cta ${revealed ? "revealed" : ""}`,
          onClick: fetchAndReveal,
          disabled: loading,
          children: loading ? "Loading…" : revealed ? "Check again" : "Check your playtime"
        }, undefined, false, undefined, this)
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: `content ${revealed ? "visible" : ""}`,
        children: [
          revealed && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
            className: "auth-row",
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("a", {
          ...
          revealed && !error && /* @__PURE__ */ jsx_dev_runtime.jsxDEV(jsx_dev_runtime.Fragment, {
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h2", {
                children: "Library"
              }, undefined, false, undefined, this),
              games.length === 0 ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
                className: "loading",
                children: "No games in library."
              }, undefined, false, undefined, this) : /* @__PURE__ */ jsx_dev_runtime.jsxDEV("ul", {
                className: "library",
                children: games.map((game) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("li", {
                  className: "game-card",
                  children: [
                    game.iconUrl ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV("img", {
                      src: game.iconUrl,
                      alt: "",
                      className: "game-icon",
                      width: 48,
                ...
                }, game.appId, true, undefined, this))
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this)
        ]
...
import_client.createRoot(root).render(/* @__PURE__ */ jsx_dev_runtime2.jsxDEV(App, {}, undefined, false, undefined, this));
